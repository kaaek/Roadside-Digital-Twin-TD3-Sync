...
class Td3PolicyWrapper:
    """Expose a Stable-Baselines3 TD3 model through the project policy API."""

    def __init__(self, model, deterministic: bool = True) -> None:
        """Store a TD3 model and deterministic/stochastic prediction mode."""
        self.model = model
        self.deterministic = deterministic

    def select_action(self, environment: LeaderSynchronizationEnv) -> np.ndarray:
        """Predict one TD3 action from the current simulator observation."""
